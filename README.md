...
desktop client. The missing piece is the device-side TSMS authentication context
generated by AppGallery; the ordinary model, capability, GPU, and version fields
are not sufficient.
